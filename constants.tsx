...
import { ItineraryDay, ItineraryPackage } from './types';

export const DEFAULT_DAYS: ItineraryDay[] = [
  {
    id: 'd1',
    dayNumber: 1,
...
export const INITIAL_PACKAGES: ItineraryPackage[] = [
  {
    id: 'p1',
...
export const PACKAGE_PRICE_PER_CHILD = 22000;
